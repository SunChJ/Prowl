...
- Updated 2026-08-22: Hardened A2 after review: capped prompts bypass canonical PTY input through a self-cleaning surface-environment carrier, prompted success declares its delivery protocol, launch failures retain typed reasons, interactive stdin/version skew fail closed, and hidden-worktree background selection is covered — see [005-cli-profile-launch.md](005-cli-profile-launch.md#review-hardening).
